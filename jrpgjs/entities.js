...
class Player extends Entity {
  constructor(gridX, gridY, texture) {
    ...
    this.animDown = [new PIXI.Texture(_texture, new PIXI.Rectangle(Math.round(0), Math.round(0), Math.round(_texture.width / 4), Math.round(_texture.height / 4))), new PIXI.Texture(_texture, new PIXI.Rectangle(Math.round(_texture.width / 4), Math.round(0), Math.round(_texture.width / 4), Math.round(_texture.height / 4))), new PIXI.Texture(_texture, new PIXI.Rectangle(Math.round(_texture.width / 2), Math.round(0), Math.round(_texture.width / 4), Math.round(_texture.height / 4))), new PIXI.Texture(_texture, new PIXI.Rectangle(Math.round(_texture.width / 4 * 3), Math.round(0), Math.round(_texture.width / 4), Math.round(_texture.height / 4)))];
    this.animLeft = [new PIXI.Texture(_texture, new PIXI.Rectangle(Math.round(0), Math.round(_texture.height / 4), Math.round(_texture.width / 4), Math.round(_texture.height / 4))), new PIXI.Texture(_texture, new PIXI.Rectangle(Math.round(_texture.width / 4), Math.round(_texture.height / 4), Math.round(_texture.width / 4), Math.round(_texture.height / 4))), new PIXI.Texture(_texture, new PIXI.Rectangle(Math.round(_texture.width / 2), Math.round(_texture.height / 4), Math.round(_texture.width / 4), Math.round(_texture.height / 4))), new PIXI.Texture(_texture, new PIXI.Rectangle(Math.round(_texture.width / 4 * 3), Math.round(_texture.height / 4), Math.round(_texture.width / 4), Math.round(_texture.height / 4)))];
    this.animRight = [new PIXI.Texture(_texture, new PIXI.Rectangle(Math.round(0), Math.round(_texture.height / 2), Math.round(_texture.width / 4), Math.round(_texture.height / 4))), new PIXI.Texture(_texture, new PIXI.Rectangle(Math.round(_texture.width / 4), Math.round(_texture.height / 2), Math.round(_texture.width / 4), Math.round(_texture.height / 4))), new PIXI.Texture(_texture, new PIXI.Rectangle(Math.round(_texture.width / 2), Math.round(_texture.height / 2), Math.round(_texture.width / 4), Math.round(_texture.height / 4))), new PIXI.Texture(_texture, new PIXI.Rectangle(Math.round(_texture.width / 4 * 3), Math.round(_texture.height / 2), Math.round(_texture.width / 4), Math.round(_texture.height / 4)))];
    this.animUp = [new PIXI.Texture(_texture, new PIXI.Rectangle(Math.round(0), Math.round(_texture.height / 4 * 3), Math.round(_texture.width / 4), Math.round(_texture.height / 4))), new PIXI.Texture(_texture, new PIXI.Rectangle(Math.round(_texture.width / 4), Math.round(_texture.height / 4 * 3), Math.round(_texture.width / 4), Math.round(_texture.height / 4))), new PIXI.Texture(_texture, new PIXI.Rectangle(Math.round(_texture.width / 2), Math.round(_texture.height / 4 * 3), Math.round(_texture.width / 4), Math.round(_texture.height / 4))), new PIXI.Texture(_texture, new PIXI.Rectangle(Math.round(_texture.width / 4 * 3), Math.round(_texture.height / 4 * 3), Math.round(_texture.width / 4), Math.round(_texture.height / 4)))];
